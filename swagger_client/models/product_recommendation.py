...
class ProductRecommendation(object):
    ...
    """
    def __init__(self, product=None, relevance=None):
        """
        ProductRecommendation - a model defined in Swagger
    ...
    def product(self):
        """
        Gets the product of this ProductRecommendation.
        ...
        :return: The product of this ProductRecommendation.
        :rtype: Product
        """
    ...
    def product(self, product):
        """
        Sets the product of this ProductRecommendation.
        Specified product attributes. Will default to primaryId and label. Please contact Halla representative to change response fields.

        :param product: The product of this ProductRecommendation.
        :type: Product
        """
    ...
    def relevance(self):
        """
        Gets the relevance of this ProductRecommendation.
        Double denoting recommendation relevance, the higher the number the more relevant.

        :return: The relevance of this ProductRecommendation.
        :rtype: float
        """
    ...
    def relevance(self, relevance):
        """
        Sets the relevance of this ProductRecommendation.
        Double denoting recommendation relevance, the higher the number the more relevant.

        :param relevance: The relevance of this ProductRecommendation.
        :type: float
        """
