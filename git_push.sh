...
sed  's#https://github.com/GIT_USER_ID/GIT_REPO_ID.git#https://github.com/HallaApp/python-client.git#g' README.md > temp.md
rm README.md
cp temp.md README.md
...
echo "Git pushing to https://github.com/${git_group_id}/${git_repo_id}.git"
